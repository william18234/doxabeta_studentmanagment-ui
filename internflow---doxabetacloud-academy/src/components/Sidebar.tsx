...
export const Sidebar: React.FC<SidebarProps> = ({ activeTab, setActiveTab }) => {
        ...
        {items.map(item => {
          ...
          return (
            <button
              ...
              className={`w-full flex items-center justify-between px-3 py-2 rounded-md transition-all cursor-pointer text-xs ${
                isSelected
  ...
  return (
    <aside className="w-full md:w-64 bg-slate-900 flex flex-col shrink-0 border-r border-slate-800 shadow-xl select-none">
